...
def task_1():
    ...
    with open("./data_folder/products.json") as F:
...
def task_2():  # есть возможность добавить своё
    with open("./data_folder/products.json") as f:
        file2 = json.load(f)
    ...
    with open('./data_folder/products.json', 'w', encoding='utf-8') as f:
...
def task_3():
    ...
    with open('./data_folder/en-ru.txt', 'r', encoding='utf-8') as F:
        data = F.readlines()
    ...
    with open('./data_folder/ru-en.txt', 'w', encoding='utf-8') as F:
